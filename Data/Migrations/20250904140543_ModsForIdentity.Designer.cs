...
namespace Data.Migrations
{
    ...
    [Migration("20250904140543_ModsForIdentity")]
    partial class ModsForIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Models.AppUser", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .HasDatabaseName("ix_asp_net_users_name");
            ...
            modelBuilder.Entity("Data.Models.RefreshToken", b =>
                {
                    b.HasOne("Data.Models.AppUser", "User")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_refresh_tokens_app_user_user_id");
